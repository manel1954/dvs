...
<button class="button link_dmr" ><a href="/dvs/config/git_pull.php" class="btn btn-danger" style="color:#fff;">UPDATE</a</buttton>

</fieldset>

<div>
<button class="button link_dmr" ><a href="/dvs/brandmeister.php" class="btn btn-danger" style="color:#fff;">MODE BMXXXXXXXXXXXXX</a</buttton>
