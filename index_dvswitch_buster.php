...
<head> 
<div>
<button2 class="button2 link_verde_claro" ><a href="/dvs/config/desactivar_hblink.php" class="btn btn-danger" style="color:#9af240;">DESACTIVAR HBLINK</a</buttton>
</div> 
...
<head> 
<div>
<button2 class="button2 link_rojo" ><a href="/dvs/config/activar_hblink.php" class="btn btn-danger" style="color:#f00;">ACTIVAR HBLINK</a</buttton>
</div>
