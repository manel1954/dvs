...
$address = exec("sed -n '70p' /opt/MMDVM_Bridge/MMDVM_Bridge_TGIF.ini");
$address = substr("$address", 8, 30);

$port = exec("sed -n '71p' /opt/MMDVM_Bridge/MMDVM_Bridge_TGIF.ini");
$port = substr("$port", 5, 5);

$password = exec("sed -n '74p' /opt/MMDVM_Bridge/MMDVM_Bridge_TGIF.ini");
