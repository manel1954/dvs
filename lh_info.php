...
<!-- <span style="font-weight: bold;font-size:14px;">Gateway Activity</span>
 -->
 <fieldset style="height:130px;margin-top:10px;background:#BD6D5A;border-radius:10px;">
...
for ($i = 0;  ($i <= 0); $i++) { //Last 20 calls
	if (isset($lastHeard[$i])) {
		...
		echo"<td align=\"center\" style=\"color:green; font-weight:bold;height:60px;font-size:22px;\">&nbsp;$listElem[1]</td>";
		if ((is_numeric($listElem[2]) || strpos($listElem[2], "openSPOT") !== FALSE) && (strlen($listElem[2])==7)) {
		    echo "<td align=\"center\" style=\"color:#464646;background:#000;\">&nbsp;<a href=\"https://database.radioid.net/database/view?id=$listElem[2]\" target=\"_blank\"><span style=\"color:#464646;font-weight:bold;height:60px;\">$listElem[2]</span></a></td>";
		} elseif (!preg_match('/[A-Za-z].*[0-9]|[0-9].*[A-Za-z]/', $listElem[2])|| $listElem[2] == "N0CALL") {
 	                       echo "<td align=\"center\" style=\"color:#464646;background:#000;height:60px;\"><b>&nbsp;$listElem[2]</b></td>";
		} else {
...
echo "<td align=\"center\" >&nbsp;<a href=\"http://www.qrz.com/db/$listElem[2]\" target=\"_blank\"><b>$listElem[2]</b></a><span>/$listElem[3]</span></td>";
		    } else {
			
			
			// INDICATIVO tamaño indicativo y fonfo indicativo ***********************************
echo "<td align=\"center\" style=\"background:#000;font-size:90px;height:100px;\" >&nbsp;<a href=\"http://www.qrz.com/db/$listElem[2]\"  target=\"_blank\"><b>$listElem[2]</b></a></td>";
		    }
		}
		...
		if ( substr($listElem[4], 0, 6) === 'CQCQCQ' ) {
			echo "<td align=\"left\">&nbsp;<span style=\"color:#b5651d;font-weight:bold;font-size:23px;\">$listElem[4]</span></td>";
		} else {
			echo "<td align=\"left\">&nbsp;<span style=\"color:#b5651d;font-weight:bold;font-size:23px;\">".str_replace(" ","&nbsp;", $listElem[4])."</span></td>";
		}
...
/* 		if ($listElem[5] == "LNet"){
		...
		if ($listElem[6] == null) {
                             if ($listElem[1] == "DMR Slot 2" && $listElem[5] == "Net")  {echo "<td colspan=\"3\" style=\"background:#f00;font-size:22px;\">&nbsp;&nbsp;&nbsp;RX DMR&nbsp;&nbsp;&nbsp;</td>";}
                             if ($listElem[1] == "DMR Slot 1" && $listElem[5] == "Net")  {echo "<td colspan=\"3\" style=\"background:#f00;font-size:22px;\">&nbsp;&nbsp;&nbsp;RX DMR&nbsp;&nbsp;&nbsp;</td>";}
			     ...
			     if ($listElem[1] == "NXDN" && $listElem[5] == "Net")  {echo "<td colspan=\"3\" style=\"background:#c9f;\">&nbsp;&nbsp;&nbsp;RX NXDN&nbsp;&nbsp;</td>";}
                             ...
                             if ($listElem[5] == "LNet")  {echo "<td colspan=\"3\" style=\"background:#f00;font-size:20px\">TX</td>";}
			} else if ($listElem[6] == "DMR Data") {
				echo "<td colspan=\"3\" style=\"background:#1d1;font-size:20px;\">DMR Data</td>";
